import { Themes } from './BUIPrivateThemeAtomsType';

import { getAlphaTransformer } from '@fb-theme/BUIPrivateAlphaTransformer';
import { FONT_FAMILY, LETTER_SPACING } from '@fb-theme/BUISystemFonts';
...
export const BUIPrivateThemeAtomsClassic = {
  ...
  layout: {
    ...
    modal: {
      boxShadow: '0 0 0 1px rgba(0, 0, 0, 0.1), 0 16px 32px 2px rgba(0, 0, 0, 0.15)',
    },
    tile: {
      padding: 8,
      selected: {
